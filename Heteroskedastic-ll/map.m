...
TRAINING_POINTS = csvread(strcat('../Stochpy-ll/results/ML_TRAINING_POINTS_', NAME))
TRAINING_POINTS_INPUT = csvread(strcat('../Stochpy-ll/results/ML_TRAINING_POINTS_INPUT_', NAME))
TRAINING_POINTS_INPUT_VARIANCE = csvread(strcat('../Stochpy-ll/results/ML_TRAINING_POINTS_VARIANCE_', NAME))
...
title('Correction Map for E[p(phi)]')
...
if (LOGTRANSFORM)
	...
	ci_upper_h = conf_int_h
	ci_lower_h =  conf_int_h
end
...
if (LOGTRANSFORM)
	...
	h = plot(TEST_POINTS, gpMean-conf_int, 'c-');
	h = plot(TEST_POINTS, gpMean_h+conf_int_h, 'r-');
	ph = plot(TEST_POINTS, gpMean_h-conf_int_h, 'r-');
end
